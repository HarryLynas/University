...
public class TestPCA {
	public static void main(String... args) throws Exception {
		FileInputStream fs = new FileInputStream("//ndrive/pm002501/.do_not_delete/desktop.xp/db.db2.txt");
		...
		for (String image : images) {
			...
			LookupResult[] results = lookup.lookupInCache(1);	
			++count;
			if (results.length == 0 || results[0].getDistance() > 18) {
				++fails;
